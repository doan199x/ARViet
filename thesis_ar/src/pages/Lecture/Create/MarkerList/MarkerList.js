                    ...
                    <div>
                        <div className={classes.data}>
                            {markerList
                                ...
                                .reverse()
                                .map((ele, i) => (
                                    <Marker lessonID={props.lessonID} cbsetCurrentActionID={cbsetCurrentActionID} currentMarkerID={currentMarkerID} cbsetCurrentMarkerID={cbsetCurrentMarkerID} index={markerList.length - i} key={i + 1} data={ele} />
                                ))}
                        </div>
                    </div>
                ) : (
                ...
                <div className={classes.inline}>
                    <div style={{ marginLeft: "12%" }}>
                        <Button onClick={() => addMarker()}
                            style={{ minWidth: "25px" }}
                            color="primary" variant="outlined"><FontAwesomeIcon icon={faPlus} size="lg" color="#3F51B5" />&nbsp;Thêm
                        </Button>
                    </div>
                    <div>
